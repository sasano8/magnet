...
Revision ID: 20200929_084536
Revises: 20200929_084414
Create Date: 2020-09-29 08:45:36.857247
...
revision = '20200929_084536'
down_revision = '20200929_084414'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix___crypto_ohlc_daily_id'), '__crypto_ohlc_daily', ['id'], unique=False)
    ...
    op.create_index(op.f('ix___topic_id'), '__topic', ['id'], unique=False)
    op.drop_index('ix_store_topic_id', table_name='store_topic')
    op.drop_table('store_topic')
    op.drop_index('ix_store_crypto_ohlc_daily_id', table_name='store_crypto_ohlc_daily')
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='store_crypto_ohlc_daily_pkey')
    )
    op.create_index('ix_store_crypto_ohlc_daily_id', 'store_crypto_ohlc_daily', ['id'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id', name='store_topic_pkey')
    )
    op.create_index('ix_store_topic_id', 'store_topic', ['id'], unique=False)
    op.drop_index(op.f('ix___topic_id'), table_name='__topic')
    op.drop_table('__topic')
    op.drop_index(op.f('ix___crypto_ohlc_daily_id'), table_name='__crypto_ohlc_daily')
