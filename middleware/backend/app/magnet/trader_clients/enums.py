...
cryptowatch_currency_pair = Literal[
    "btcjpy"
]
...
mapping_currency_pairs_cryptowatch_to_zaif = {
    "btcjpy": "btc_jpy"
}


@validate_arguments
def convert_currency_pair_original(currency_pair: cryptowatch_currency_pair, dest_exchange: exchanges) -> str:
